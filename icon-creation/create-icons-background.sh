...
# Additionally generate a large 1024x1024 icon with background color (non-transparent)
OUTPUT_FILE="$OUTPUT_DIR/large-w-background-1024.png"
echo "Generating $OUTPUT_FILE..."
inkscape "$INPUT_FILE_BG" \
  --export-filename="$OUTPUT_FILE" \
  --export-width=1024 \
  --export-height=1024 \
  --export-background="#E9F8FF" \
