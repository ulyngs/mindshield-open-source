...
const cssSelectors = {
    ...
    youtubeThumbnailsCssBlur: 'ytd-thumbnail img, ytd-playlist-thumbnail img, .yt-thumbnail-view-model__image img { filter: blur(7px) !important; } /* mobile */ .media-item-thumbnail-container, .video-thumbnail-img { filter: blur(7px); } ytd-thumbnail, ytd-playlist-thumbnail { display: block !important; } /* Ensure container is visible for blur */',
    youtubeThumbnailsCssBlack: 'ytd-thumbnail img, ytd-playlist-thumbnail img, .yt-thumbnail-view-model__image img { filter: brightness(0) !important; } /* mobile */ .media-item-thumbnail-container, .video-thumbnail-img { filter: brightness(0); } ytd-thumbnail, ytd-playlist-thumbnail { display: block !important; } /* Ensure container is visible for black */',
