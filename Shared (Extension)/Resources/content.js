(function() {
    ...
    const youtubeLikesCssOff = 'ytd-watch-metadata #top-level-buttons-computed yt-animated-rolling-number { display: none; } /* m.youtube.com */ ytm-slim-video-metadata-section-renderer like-button-view-model .yt-spec-button-shape-next__button-text-content { display: none; }';
